...
import { TodoListItemType, TodoListType } from "../../Types/TodoList/TodoList";
		...
		<div className="todolist">
			...
			<div className="header">
				...
				<div className="weather">
					<img
						src={
							"https://github.com/Kijun-Park/react-boilerplate/assets/35815788/3bf2ff46-2657-415c-94a1-97c600c82e79"
						}
						alt={`sunny`}
					/>
					<span>
			...
			{/* todo list */}
			<div className="todoList">
				{todoList.map((item: TodoListType): ReactNode => {
					return (
						<div className="todoList_card">
							...
							<div className="todolist-specifics">
								{item.items.map((specific: TodoListItemType): ReactNode => {
									return (
